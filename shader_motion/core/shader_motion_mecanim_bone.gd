...
func analyze_bone_from(pixels: SpriteFrames, bone: ShaderMotionHelpers.MecanimBodyBone, bone_name: String):
	...
	var parsed_angles: PackedFloat64Array = _decode_tiles(
		pixels, bone_tiles, bone == ShaderMotionHelpers.MecanimBodyBone.Hips
	)
